...
import edu.grupo2.desarrollo.tecnobedeliasapp.dummy.DummyContent;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(NoticiaDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(NoticiaDetailFragment.ARG_ITEM_ID, item.id);
